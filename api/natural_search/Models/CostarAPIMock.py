...
class CostarAPIMock(object):
    def __init__(self, 
		...
		# Property Status
		property_status, # Only Net-Leased Properties, Include Pending Sales, Only Distressed Properties, Only Property Auctions
		#Tenancy
		...
		short_term,
		# Square Feet
		square_feet_minimum, # No Min, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2500, 3000, 3500, 4000, 4500
